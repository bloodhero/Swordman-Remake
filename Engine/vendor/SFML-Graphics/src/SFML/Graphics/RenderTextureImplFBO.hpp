...
private:
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::optional<unsigned int>    m_frameBuffer;            //!< OpenGL frame buffer objects per context
    std::optional<unsigned int>    m_multisampleFrameBuffer; //!< Optional per-context OpenGL frame buffer objects with multisample attachments
