...
#include <glad/glad.h>
    ...
    #define GLEXT_multitexture                        GL_ARB_multitexture
    ...
    #define GLEXT_blend_func_separate                 GL_EXT_blend_func_separate
    #define GLEXT_glBlendFuncSeparate                 glBlendFuncSeparateEXT

    // Core since 1.5 - ARB_vertex_buffer_object
    #define GLEXT_vertex_buffer_object                GL_ARB_vertex_buffer_object
    ...
    #define GLEXT_shading_language_100                GL_ARB_shading_language_100

    // Core since 2.0 - ARB_shader_objects
    #define GLEXT_shader_objects                      GL_ARB_shader_objects
    ...
    #define GLEXT_vertex_shader                       GL_ARB_vertex_shader
    ...
    #define GLEXT_packed_depth_stencil                GL_EXT_packed_depth_stencil
    #define GLEXT_GL_DEPTH24_STENCIL8                 GL_DEPTH24_STENCIL8_EXT

    // Core since 3.0 - EXT_framebuffer_blit
    #define GLEXT_framebuffer_blit                    GL_EXT_framebuffer_blit
    ...
    #define GLEXT_framebuffer_multisample             GL_EXT_framebuffer_multisample
    ...
    #define GLEXT_copy_buffer                         GL_ARB_copy_buffer
    ...
    #define GLEXT_geometry_shader4                    GL_ARB_geometry_shader4
